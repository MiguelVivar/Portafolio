    ...
    <nav className="flex space-x-3" aria-label="Enlaces del proyecto">
      {enlaces.map((enlace, index) => (
        <Link
          ...
          className={`inline-flex items-center gap-1 text-sm font-medium transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-300/50 rounded px-2 py-1 ${
            enlace.tipo === "github"
